...
def test_imports():
    ...
    from llmzip.models import create_model, BaseProbabilityModel
    from llmzip.arithmetic import ArithmeticEncoder, ArithmeticDecoder
    from llmzip.preprocessing import Preprocessor
    from llmzip.context import ContextManager
    from llmzip.file_format import FileMetadata
    print("   ✓ Все модули импортированы успешно")


def test_models_registry():
    print("2. Проверка реестра моделей...")
    from llmzip import list_available_models
...
def test_arithmetic():
    ...
    import numpy as np
    from src.llmzip.arithmetic import ArithmeticEncoder, ArithmeticDecoder
...
def test_file_format():
    ...
    import tempfile
    import numpy as np
    from src.llmzip.file_format import FileMetadata, save_compressed, load_compressed
